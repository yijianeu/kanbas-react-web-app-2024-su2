        ...
        <div id="wd-assignments-editor" className="container">
            <div id="wd-assignments-name" className="mb-3">
                ...
                <div id="wd-assignment-name-input">
                    <input id="wd-name" value={name} className="form-control" readOnly />
                </div>
            </div>
            ...
            <form>
                <div id="wd-assignments-points" className="mb-3 form-group row">
                    ...
                    <div className="col-8">
                        <input id="wd-points" value={points} className="form-control" readOnly />
                    </div>
                </div>
                ...
                <div id="wd-display-grade-as" className="mb-3 form-group row">
                    <div className="col-4 position-relative">
                        <label htmlFor="wd-display-grade-as" className="position-absolute end-0">Display Grade as</label>
                    </div>
                    <div className="col-8">
                ...
                <div id="wd-submission-type" className="mb-3 form-group row">
                    <div className="col-4 position-relative">
                        <label htmlFor="wd-submission-type" className="position-absolute end-0">Submission Type</label>
                    </div>
                    <div className="col-8">
                        <div className="form-control">
                            ...
                            <div className="form-check mb-2">
                                <input type="checkbox" name="Online Entry Options" id="wd-text-entry" className="form-check-input" />
                                <label htmlFor="wd-text-entry" className="form-check-label">Text Entry</label>
                            </div>

                            <div className="form-check mb-2">
                                <input type="checkbox" name="Online Entry Options" id="wd-website-url" className="form-check-input" />
                                <label htmlFor="wd-website-url" className="form-check-label">Website URL</label>
                            </div>

                            <div className="form-check mb-2">
                                <input type="checkbox" name="Online Entry Options" id="wd-media-recordings" className="form-check-input" />
                                <label htmlFor="wd-media-recordings" className="form-check-label">Media Recordings</label>
                            </div>

                            <div className="form-check mb-2">
                                <input type="checkbox" name="Online Entry Options" id="wd-student-annotation" className="form-check-input" />
                                <label htmlFor="wd-student-annotation" className="form-check-label">Student Annotation</label>
                            </div>

                            <div className="form-check mb-2">
                                <input type="checkbox" name="Online Entry Options" id="wd-file-upload" className="form-check-input" />
                    ...
                    <div className="col-8">
                        <div className="form-control">
                            ...
                            <div className="mb-2">
                                ...
                                <input type="date" id="wd-due-date" value={due} className="form-control" readOnly />
                            </div>

                            <div className="mb-3 row">
                                <div className="col-6">
                                    <label htmlFor="wd-available-from"><strong>Available from</strong></label>
                                    <input type="date" id="wd-available-from" value={available} className="form-control" readOnly />
                                </div>
                                <div className="col-6">
                                    <label htmlFor="wd-available-until"><strong>Until</strong></label>
                                    <input type="date" id="wd-available-until" value={due} className="form-control" readOnly />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <Link to={`/Kanbas/Courses/${cid}/Assignments`}>
                <button className="btn btn-danger me-1 float-end rounded-1">Save</button>
            </Link>
            <Link to={`/Kanbas/Courses/${cid}/Assignments`}>
