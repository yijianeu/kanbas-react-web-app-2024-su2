    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                My favorite recipe:
                <ol>
                    <li>Cook the spaghetti in a large pot of boiling salted water according to package instructions.
                    </li>
                    <li>In a separate pan, cook the pancetta with the garlic until crispy. Remove the garlic cloves.
                    </li>
                    <li>In a bowl, beat the eggs and mix in the grated Pecorino and Parmesan cheese.</li>
                    <li>Drain the spaghetti and add it to the pan with the pancetta. Remove the pan from heat.</li>
                    <li>Quickly pour the egg and cheese mixture over the pasta, stirring continuously to create a creamy
                        sauce.
                    </li>
                    <li>Season with freshly ground black pepper and salt to taste.</li>
                    <li>Serve immediately with extra grated Pecorino and Parmesan cheese on top.</li>
                </ol>
            </div>
